...
class WorkerPage extends Component {
  ...
  render() {
    ...
    if(this.state.statePage === 0){
      ...
      Page = <div style={{height:"100%"}}><NavBar numberUser={this.props.user}/><AsideBar/><PostAndCategory numberUser={this.props.user} timing={this.state.timingCategories} change={this.changeState2.bind(this)}/></div>
